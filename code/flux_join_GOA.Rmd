...
# '-------'|        | # layer 2: face surface of box2 is larger (i.e. deeper), but both boxes have face surface at this depth (surface = min(surface1, surface2))
...
atlantis_sf %>% left_join(mean_w_at_interface,by='.bx0') %>%
  ...
  theme_minimal()
```
MOst vertical fluxes seem to be upward. This is suspicious for a downwelling system like the GOA - check the calculations.
